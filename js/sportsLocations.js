...
locations.push(new SportsLocation({
	league: "MLS", type: "MLS",
	locationName: "Yankee Stadium", sportsCity: "New York", locationCity: "New York, NY", 
	latitude: "40.829643", longitude: "-73.9261745",
...
locations.push(new SportsLocation({
	league: "MLS", type: "MLS",
	locationName: "CenturyLink Field", sportsCity: "Seattle", locationCity: "Seattle, WA", 
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Barclays Center", sportsCity: "Brooklyn", locationCity: "Brooklyn, NY", 
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Wells Fargo Center", sportsCity: "Philadelphia", locationCity: "Phildelphia, PA", 
	latitude: "39.9012", longitude: "-75.1719785",
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Staples Center", sportsCity: "Los Angeles", locationCity: "Los Angeles, CA", 
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "TD Garden", sportsCity: "Boston", locationCity: "Boston, MA",
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Time Warner Cable Arena", sportsCity: "Charlotte", locationCity: "Charlotte, NC",
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Air Canada Centre", sportsCity: "Toronto", locationCity: "Toronto, ON",
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Quicken Loans Arena", sportsCity: "Cleveland", locationCity: "Cleveland, OH",
...
locations.push(new SportsLocation({
	league: "NBA", type: "NBA",
	locationName: "Palace of Auburn Hills", sportsCity: "Detroit", locationCity: "Auburn Hills, MI",
...
locations.push(new SportsLocation({
	...
	latitude: "39.2845", longitude: "-76.62155",
...
locations.push(new SportsLocation({
	...
	latitude: "40.4468554", longitude: "-80.005666"
}));

locations.push(new SportsLocation({
	league: "MLB", type: "MLB",
	locationName: "Yankee Stadium", sportsCity: "New York", locationCity: "New York, NY", 
	latitude: "40.82964", longitude: "-73.9252",
}));

locations.push(new SportsLocation({
	league: "MLB", type: "MLB",
	locationName: "Fenway Park", sportsCity: "Boston", locationCity: "Boston, MA", 
	latitude: "42.346676", longitude: "-71.097218",
}));

locations.push(new SportsLocation({
	league: "MLB", type: "MLB",
	locationName: "SunTrust Park", sportsCity: "Atlanta", locationCity: "Atlanta, GA", 
	latitude: "33.8907", longitude: "-84.467684",
}));

locations.push(new SportsLocation({
	league: "MLB", type: "MLB",
	locationName: "AT&T Park", sportsCity: "San Francisco", locationCity: "San Francisco, CA", 
	latitude: "37.778595", longitude: "-122.389270",
}));

locations.push(new SportsLocation({
	league: "MLB", type: "MLB",
	locationName: "Safeco Field", sportsCity: "Seattle", locationCity: "Seattle, WA", 
	latitude: "47.591391", longitude: "-122.332327",
}));
...
locations.push(new SportsLocation({
	...
	latitude: "39.278", longitude: "-76.6218",
...
locations.push(new SportsLocation({
	...
	ticketUrl: "../../Sports Travels/NCAA Basketball/Maryland Terrapins vs Michigan State 2015-01-17.pdf"
}));
